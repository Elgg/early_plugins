<?php
	 ...
	 * It is worth noting that due to the nature of a messaging system and the fact 2 or more people access
	 * the message, messages don't actually delete, they are just removed from view for the user who deletes
	 * 
    ...
    // Make sure we actually have permission to edit and that the object is of sub-type messages
		if ($message->getSubtype() == "messages") {
    		    ...
    		    //check to see if it is a message from the sent items of inbox to be deleted
			    if($type == 'sent'){
