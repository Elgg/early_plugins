...
<p>
    Number of messages to display:
        <select name="params[num_display]">
		    ...
		    <option value="7" <?php if($vars['entity']->num_display == 6) echo "SELECTED"; ?>>7</option>
		    <option value="8" <?php if($vars['entity']->num_display == 6) echo "SELECTED"; ?>>8</option>
		    <option value="9" <?php if($vars['entity']->num_display == 6) echo "SELECTED"; ?>>9</option>
